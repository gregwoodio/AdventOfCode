...
func Test2020Day04_SolvePartOne(t *testing.T) {
	inputs := []string{
...
func Test2020Day04_SolvePartOneActual(t *testing.T) {
	if testing.Short() {
...
func Test2020Day04_SolvePartTwo(t *testing.T) {
	inputs := []string{
		// invalid
		"eyr:1972 cid:100",
...
func Test2020Day04_SolvePartTwoActual(t *testing.T) {
	if testing.Short() {
		t.Skip("Skipping actual solution")
	}
